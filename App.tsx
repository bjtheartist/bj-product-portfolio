        ...
        <section className="py-32 md:py-48 px-6 md:px-12 bg-white text-black relative overflow-hidden z-10">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 bento-grid">
               ...
               <div className="md:col-span-4 bg-zinc-100 border border-black/5 p-10 md:p-16 rounded-2xl bento-item flex flex-col justify-end min-h-[300px] md:min-h-[400px] overflow-hidden relative group shadow-sm">
                  <img
                    src="https://picsum.photos/seed/office/800/600"
                    alt="Studio workspace"
                    loading="lazy"
                    className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:scale-105 transition-all duration-1000 group-hover:opacity-70 bg-zinc-200"
                  />
                  <div className="relative z-10">
