            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className={`relative overflow-hidden ${
                  ...
                  <div className="absolute top-6 right-6 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                    <span className="text-[10px] font-medium tracking-wide text-white/80 uppercase">View Details</span>
