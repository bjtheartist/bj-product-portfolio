      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12 -mt-20">
          ...
          <div className="max-w-md text-right">
            ...
            <button className="mt-10 flex items-center gap-4 text-xs font-black tracking-widest ml-auto group uppercase">
              ALL PROJECTS
              <span className="w-12 h-12 rounded-full bg-black text-white flex items-center justify-center transition-all group-hover:bg-zinc-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-10">
          {PROJECTS.map((project, index) => (
            <div key={project.id} className={`project-card group cursor-pointer ${index % 2 === 1 ? 'md:mt-4' : 'md:mb-4'}`}>
              <div className="relative overflow-hidden aspect-[3/4] mb-8 bg-zinc-100 rounded-lg shadow-2xl">
                <img
                ...
                <div className="absolute top-6 left-6">
                  <span className="bg-white/80 backdrop-blur-xl px-5 py-2 text-[9px] font-black tracking-[0.3em] border border-black/10 uppercase rounded-full text-black">
                    {project.category}
                  </span>
                </div>
              ...
              <h3 className="text-3xl font-black tracking-tighter mb-4 uppercase group-hover:text-zinc-500 transition-colors">{project.title}</h3>
