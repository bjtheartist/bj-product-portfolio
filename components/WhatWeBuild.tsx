...
const WhatWeBuild: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute -bottom-24 -right-24 w-72 h-72 border border-[#1c1a17] opacity-[0.06] pointer-events-none"
        style={{
      ...
      {/* Inner diamond */}
      <div
        className="absolute -bottom-16 -right-16 w-48 h-48 border-[1px] border-[#1c1a17] opacity-[0.04] pointer-events-none"
        style={{
          transform: 'rotate(45deg)',
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-8">
          {PILLARS.map((pillar, index) => (
            ...
            >
              <div
                className="bg-[#f5f2eb] border border-[#1c1a17] p-8 md:p-6 lg:p-8 h-full"
                style={{ boxShadow: '4px 4px 0 #1c1a17' }}
              >
                {/* Pillar number */}
                <span
                  className="text-5xl font-black text-[#1c1a17]/10 leading-none block mb-4"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  0{index + 1}
                </span>
                ...
                {/* Pillar description */}
                <p className="text-base text-[#1c1a17]/70 leading-relaxed">
                  {pillar.description}
                </p>
              </div>
            </div>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-8 h-px bg-[#1c1a17]" />
            <span className="text-[#1c1a17]">&#9670;</span>
            <div className="w-8 h-px bg-[#1c1a17]" />
          </div>
          <p className="text-lg md:text-xl text-[#1c1a17]/70 leading-relaxed">
