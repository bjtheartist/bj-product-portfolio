...
const ResultsStrip: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#1c1a17] py-16 md:py-20 overflow-hidden"
    >
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 mb-10 sm:mb-16">
          {PILLARS.map((pillar, index) => (
            ...
            >
              <span
                className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#1c1a17] leading-none mb-3"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                {pillar.title}
              </span>
              <span className="block text-sm text-[#f5f2eb]/50">
                {pillar.detail}
              </span>
            </div>
          ))}
        ...
        {/* Divider */}
        <div
          className={`w-full h-px bg-[#f5f2eb]/10 mb-12 transition-all duration-700 delay-500 ${
        ...
        >
          <blockquote className="text-[#f5f2eb]/80 text-lg md:text-xl lg:text-2xl italic leading-relaxed mb-6">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <cite className="text-[#f5f2eb]/50 text-sm not-italic uppercase tracking-wider font-bold">
