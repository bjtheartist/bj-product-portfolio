            ...
            return (
              ...
              >
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all ${isActive ? 'bg-white border-white text-black' : 'border-zinc-800 text-zinc-600'}`}>
                ...
                {isActive && (
                  <div className="flex flex-col md:flex-row justify-between items-end gap-12 animate-in fade-in slide-in-from-top-4">
                    ...
                    <div className="text-right">
                       ...
                       <button className="px-8 py-3 bg-white text-black rounded-full font-black text-xs uppercase tracking-widest hover:bg-zinc-200 transition-all shadow-xl">
                         Book a call
                       </button>
                    </div>
                  </div>
